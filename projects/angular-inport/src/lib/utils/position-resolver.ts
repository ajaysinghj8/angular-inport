import { ElementBoundingPositions, Point, ElementClientRect } from './models';
...
export class PositionResolver {
	static getBoundingClientRect(element: HTMLElement): ElementClientRect {
	...
	static intersectRect(r1: ElementBoundingPositions, r2: ElementBoundingPositions): boolean {
		return !(r2.left > r1.right || r2.right < r1.left || r2.top > r1.bottom || r2.bottom < r1.top);
	}

	static offsetRect(rect: ElementClientRect, offset: Array<any>): ElementClientRect {
		if (!offset) {
			return rect;
		}
	...
	static distance(containerRect: ElementClientRect, elementRect: ElementClientRect) {
